...
if (isset($_POST['numero_aleatorio']) && $_POST['numero_aleatorio'] == $_SESSION['numero_aleatorio'] || isset($_GET['numero_aleatorio']) && $_GET['numero_aleatorio'] == $_SESSION['numero_aleatorio']){
...
<BODY>
    ...
    if (isset($_SESSION["cart_item"])) {
        ...
        foreach ($_SESSION["cart_item"] as $item) {
            ...
            ?>
                    <tr>
                        ...
                        <td style="text-align: center;"><a href="index.php?action=remove&code=<?php echo $item["code"]; ?>&numero_aleatorio=<?php echo $_SESSION['numero_aleatorio']?>" class="btnRemoveAction"><img src="icon-delete.png" alt="Remove Item" /></a></td>
                    </tr>
                            <?php
        ...
        ?>
            ...
            <input type="hidden" value="<?php echo $_SESSION['numero_aleatorio']; ?>" id="numero_aleatorio" name="numero_aleatorio">
            <?php
    } else {
        ?>
